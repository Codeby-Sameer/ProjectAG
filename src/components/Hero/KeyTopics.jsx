      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {keyTopics.map((topic, index) => (
            ...
            >
              <div className={`${topic.gradient} group-hover:bg-gradient-to-br from-blue-500 to-navy group-hover:text-white p-8 text-navy min-h-[280px] flex flex-col justify-between`}>
                ...
                <div>
                  ...
                  <p className="text-navy group-hover:text-white text-opacity-90 leading-relaxed">{topic.description}</p>
                </div>
              </div>
