...
import { 
  FaBuilding, FaHardHat, FaFilm, FaTheaterMasks, FaGlobeAmericas, 
  FaShieldAlt, FaPills, FaPrayingHands, FaPlane, FaStar, 
  FaLock, FaChartLine, FaMoneyBillWave, FaShippingFast, FaUniversity, 
  FaSeedling, FaOm, FaHandsHelping, FaUtensils, FaHome, FaArrowAltCircleDown,
  FaStore, FaTree, FaVideo, FaMusic, FaTv, FaCity,FaClock,FaGem,FaTshirt,
  FaCalendarAlt, FaMicrophone, FaAward, FaMapMarkerAlt, FaTools,
  FaUserShield, FaHotel, FaCar, FaBox, FaMap,
  FaRocket, FaShoppingCart, FaHospital, FaMountain, FaPalette,
  FaBook, FaFire, FaGraduationCap, FaHeart,
  FaCheckCircle, FaDollarSign, FaBriefcase, FaChartBar,
...
const divisions = [
  {
    ...
    // icon: <FaBuilding className="text-green-500" size={32} />,
    color: "from-green-500 to-green-700",
    bgGradient: "from-green-50 to-emerald-50",
    features: [
      { icon: <FaLock className="text-green-500" size={32} />, title: "Legal Assurance", desc: "100% clear titles" },
      { icon: <FaHome className="text-green-500" size={32} />, title: "Vastu Compliant", desc: "Scientific design" },
      { icon: <FaDollarSign className="text-green-500" size={32} />, title: "Best Value", desc: "Premium locations" },
      { icon: <FaRocket className="text-green-500" size={32} />, title: "Quick Possession", desc: "Timely delivery" }
    ],
    services: [
      {
        title: "Residential Plots",
        description: "Premium plotted developments in strategic locations with all modern amenities",
        icon: <FaHome className="text-green-400" size={32} />,
        color: "from-green-400 to-green-600"
      },
      {
        title: "Commercial Ventures",
        description: "High-return commercial properties in developing business corridors",
        icon: <FaStore className="text-blue-400" size={32} />,
        color: "from-blue-400 to-blue-600"
      },
      {
        title: "Farm Lands & Estates",
        description: "Agricultural and recreational land parcels for sustainable investments",
        icon: <FaTree className="text-emerald-400" size={32} />,
  ...
  },
  {
    ...
    // icon: <FaHardHat className="text-blue-500" size={32} />,
    color: "from-blue-500 to-blue-700",
    bgGradient: "from-blue-50 to-cyan-50",
    features: [
      { icon: <FaAward className="text-blue-500" size={32} />, title: "Quality First", desc: "ISO standards" },
      { icon: <FaLeaf className="text-blue-500" size={32} />, title: "Sustainable", desc: "Eco-friendly practices" },
      { icon: <FaRocket className="text-blue-500" size={32} />, title: "Innovation", desc: "Modern technology" },
      { icon: <FaHandsHelping className="text-blue-500" size={32} />, title: "Partnership", desc: "Collaborative approach" }
    ],
    services: [
      {
        title: "Gated Communities",
        description: "Secure, well-planned residential townships with premium amenities",
        icon: <FaBuilding className="text-blue-400" size={32} />,
        color: "from-blue-400 to-blue-600"
      },
      {
        title: "Commercial Complexes",
        description: "Modern commercial spaces designed for business success and growth",
        icon: <FaStore className="text-cyan-400" size={32} />,
        color: "from-cyan-400 to-cyan-600"
      },
      {
        title: "Smart City Projects",
        description: "Future-ready urban developments with smart technology integration",
        icon: <FaCity className="text-indigo-400" size={32} />,
  ...
  },
  {
    ...
    // icon: <FaFilm className="text-purple-500" size={32} />,
  ...
  },
  {
    ...
    // icon: <FaTheaterMasks className="text-orange-500" size={32} />,
    color: "from-orange-500 to-yellow-500",
    bgGradient: "from-orange-50 to-yellow-50",
    features: [
      { icon: <FaFilm className="text-orange-500" size={32} />, title: "Film & Entertainment Events", desc: "Audio launches, trailer events, release shows" },
      { icon: <FaBuilding className="text-orange-500" size={32} />, title: "Corporate Events", desc: "Galas, product launches, celebrity appearances" },
      { icon: <FaMicrophone className="text-orange-500" size={32} />, title: "Media Production", desc: "Satellite channel, podcasts, inspirational content" },
      { icon: <FaAward className="text-orange-500" size={32} />, title: "Award Ceremonies", desc: "Business, pharma, film & entertainment honors" }
    ],
    services: [
      {
        title: "Event Management",
        description: "Grand audio launches, movie release shows, corporate galas and cultural festivals",
        icon: <FaCalendarAlt className="text-orange-400" size={32} />,
        color: "from-orange-400 to-orange-600"
      },
      {
        title: "Media Production",
        description: "Satellite channel programming, podcast series with achievers and visionaries",
        icon: <FaMicrophone className="text-yellow-400" size={32} />,
        color: "from-yellow-400 to-yellow-600"
      },
      {
        title: "Awards & Recognition",
        description: "Prestigious award ceremonies celebrating excellence across diverse industries",
        icon: <FaAward className="text-amber-400" size={32} />,
  ...
  },
  {
    ...
    // icon: <FaGlobeAmericas className="text-blue-500" size={32} />,
    color: "from-blue-500 to-blue-600",
    bgGradient: "from-blue-50 to-cyan-50",
    features: [
      { icon: <FaBox className="text-blue-500" size={32} />, title: "Global Export", desc: "Premium goods to international markets" },
      { icon: <FaShippingFast className="text-blue-500" size={32} />, title: "National Distribution", desc: "Pan-India supply chain network" },
      { icon: <FaChartLine className="text-blue-500" size={32} />, title: "Import Solutions", desc: "Sourcing to customs clearance" },
      { icon: <FaBuilding className="text-blue-500" size={32} />, title: "Multi-Industry", desc: "Consumer goods, electronics, textiles" }
    ],
    services: [
      {
        title: "International Trade",
        description: "Exporting premium-quality goods to global markets meeting international standards",
        icon: <FaPlane className="text-blue-400" size={32} />,
        color: "from-blue-400 to-blue-600"
      },
      {
        title: "Domestic Distribution",
        description: "Well-established logistics and supply chain system across Indian states",
        icon: <FaMapMarkerAlt className="text-cyan-400" size={32} />,
        color: "from-cyan-400 to-cyan-600"
      },
      {
        title: "Import Management",
        description: "Wide range of goods from trusted international suppliers with quality assurance",
        icon: <FaBox className="text-blue-400" size={32} />,
        color: "from-blue-400 to-blue-600"
      }
    ],
  ...
  },
  {
    ...
    // icon: <FaShieldAlt className="text-slate-600" size={32} />,
  ...
  },
  {
    ...
    // icon: <FaPills className="text-green-500" size={32} />,
    ...
    services: [
      ...
      },
      {
        ...
        icon: <FaShoppingCart className="text-green-400" size={32} />,
        color: "from-green-400 to-green-600"
      },
      {
        title: "Healthcare Ecosystem",
        description: "Advanced technology combined with licensed pharmacy expertise",
        icon: <FaHospital className="text-blue-400" size={32} />,
        color: "from-blue-400 to-blue-600"
      }
    ],
  ...
  },
  {
    ...
    // icon: <FaPrayingHands className="text-yellow-500" size={32} />,
    color: "from-yellow-400 to-orange-400",
    bgGradient: "from-yellow-50 to-orange-50",
    features: [
      { icon: <FaMountain className="text-yellow-500" size={32} />, title: "Sacred Journeys", desc: "Curated spiritual experiences" },
      { icon: <FaBook className="text-yellow-500" size={32} />, title: "Cultural Immersion", desc: "Authentic temple knowledge" },
      { icon: <FaHotel className="text-yellow-500" size={32} />, title: "Themed Stays", desc: "Culturally inspired accommodations" },
      { icon: <FaOm className="text-yellow-500" size={32} />, title: "Soulful Retreat", desc: "Inner peace and clarity" }
    ],
    services: [
      {
        title: "Pilgrimage Tours",
        description: "Thoughtfully curated journeys to sacred destinations with complete guidance",
        icon: <FaMap className="text-yellow-400" size={32} />,
        color: "from-yellow-400 to-yellow-600"
      },
      {
        title: "Cultural Experience",
        description: "Authentic temple history, rituals, traditions and cultural significance",
        icon: <FaPalette className="text-orange-400" size={32} />,
        color: "from-orange-400 to-orange-600"
      },
      {
        title: "Sacred Retreats",
        description: "Thematic experiences that help devotees connect deeply with divine atmosphere",
        icon: <FaOm className="text-orange-400" size={32} />,
        color: "from-orange-400 to-orange-600"
      }
    ],
    website: "https://anand-devocation.vercel.app",
  ...
  },
  {
    ...
    // icon: <FaPlane className="text-cyan-500" size={32} />,
    color: "from-cyan-500 to-blue-500",
    bgGradient: "from-cyan-50 to-blue-50",
    features: [
      { icon: <FaCalendarAlt className="text-cyan-500" size={32} />, title: "End-to-End Planning", desc: "Complete travel coordination" },
      { icon: <FaHotel className="text-cyan-500" size={32} />, title: "Accommodation", desc: "Hotels and homestays arranged" },
      { icon: <FaMap className="text-cyan-500" size={32} />, title: "Personalized Itinerary", desc: "Comprehensive travel routes" },
      { icon: <FaClock className="text-cyan-500" size={32} />, title: "Perfect Timing", desc: "Thoughtfully planned schedules" }
    ],
    services: [
      {
  ...
  },
  {
    ...
    bgGradient: "from-purple-50 to-pink-50",
    features: [
      { icon: <FaCar className="text-purple-500" size={32} />, title: "Luxury Transport", desc: "Secure luxury vehicles" },
      { icon: <FaUserShield className="text-purple-500" size={32} />, title: "Security Personnel", desc: "Gunmen and bouncers" },
      { icon: <FaHotel className="text-purple-500" size={32} />, title: "Premium Stays", desc: "Well-maintained hotels" },
      { icon: <FaLock className="text-purple-500" size={32} />, title: "Absolute Discretion", desc: "Confidential service" }
    ],
    services: [
      {
        title: "Executive Protection",
        description: "Secure luxury cars with trained chauffeurs and professional security personnel",
        icon: <FaCar className="text-purple-400" size={32} />,
        color: "from-purple-400 to-purple-600"
      },
      {
        title: "Premium Accommodation",
        description: "Luxury hotels arranged for comfortable and private stays during travel",
        icon: <FaHotel className="text-pink-400" size={32} />,
        color: "from-pink-400 to-pink-600"
      },
      {
        title: "Complete Coordination",
        description: "Fully coordinated backend support for smooth movement across destinations",
        icon: <FaTools className="text-purple-400" size={32} />,
        color: "from-purple-400 to-purple-600"
      }
    ],
  ...
  },
  {
    ...
    // icon: <FaLock className="text-gray-600" size={32} />,
    color: "from-gray-600 to-slate-700",
    bgGradient: "from-gray-50 to-slate-50",
    features: [
      { icon: <FaVideo className="text-gray-600" size={32} />, title: "24/7 Surveillance", desc: "Continuous monitoring" },
      { icon: <FaKey className="text-gray-600" size={32} />, title: "Private Access", desc: "Easy and confidential access" },
      { icon: <FaUniversity className="text-gray-600" size={32} />, title: "Bank-Grade Safety", desc: "High-standard protection" },
      { icon: <FaBox className="text-gray-600" size={32} />, title: "Various Sizes", desc: "Multiple locker options" }
    ],
    services: [
      {
        title: "Secure Storage",
        description: "Advanced security systems with continuous surveillance and bank-grade protection",
        icon: <FaLock className="text-gray-500" size={32} />,
        color: "from-gray-500 to-gray-700"
      },
      {
        title: "Private Lockers",
        description: "Easy-access lockers in various sizes with high-standard safety measures",
        icon: <FaBox className="text-gray-500" size={32} />,
        color: "from-gray-500 to-gray-700"
      },
      {
        title: "Asset Protection",
        description: "Secure storage for jewelry, documents, heirlooms and valuable assets",
        icon: <FaGem className="text-gray-500" size={32} />,
        color: "from-gray-500 to-gray-700"
      }
    ],
  ...
  },
  {
    ...
    // icon: <FaChartLine className="text-emerald-500" size={32} />,
    color: "from-emerald-500 to-green-600",
    bgGradient: "from-emerald-50 to-green-50",
    features: [
      { icon: <FaChartBar className="text-emerald-500" size={32} />, title: "Equity Trading", desc: "Stocks and derivatives" },
      { icon: <FaSearch className="text-emerald-500" size={32} />, title: "Market Insights", desc: "Real-time data and research" },
      { icon: <FaTools className="text-emerald-500" size={32} />, title: "Trading Tools", desc: "User-friendly platforms" },
      { icon: <FaBriefcase className="text-emerald-500" size={32} />, title: "Portfolio Management", desc: "Performance monitoring" }
    ],
    services: [
      {
        title: "Trading Platform",
        description: "Equity and derivative trading across leading stock exchanges with real-time data",
        icon: <FaDesktop className="text-emerald-400" size={32} />,
        color: "from-emerald-400 to-emerald-600"
      },
      {
        title: "Investment Guidance",
        description: "Expert insights, research reports and personalized assistance for investors",
        icon: <FaGraduationCap className="text-green-400" size={32} />,
        color: "from-green-400 to-green-600"
      },
      {
  ...
  },
  {
    ...
    // icon: <FaShippingFast className="text-blue-500" size={32} />,
    color: "from-blue-500 to-purple-500",
    bgGradient: "from-blue-50 to-purple-50",
    features: [
      { icon: <FaRocket className="text-blue-500" size={32} />, title: "Priority Delivery", desc: "Domestic & international priority channels" },
      { icon: <FaBox className="text-blue-500" size={32} />, title: "Elite Packaging", desc: "Premium protective packaging standards" },
      { icon: <FaHandsHelping className="text-blue-500" size={32} />, title: "White-Glove Handling", desc: "Luxury and fragile items care" },
      { icon: <FaLock className="text-blue-500" size={32} />, title: "Discreet Logistics", desc: "Secure confidential shipments" }
    ],
    services: [
      {
        title: "Premium Shipping",
        description: "Elevated shipping experience with absolute protection and elegance",
        icon: <FaGift className="text-blue-400" size={32} />,
        color: "from-blue-400 to-blue-600"
      },
      {
      ...
      },
      {
        ...
        icon: <FaHandsHelping className="text-blue-400" size={32} />,
        color: "from-blue-400 to-blue-600"
      }
    ],
    website: "https://anand-shipping.vercel.app/",
  ...
  },
  {
    ...
    // icon: <FaUniversity className="text-green-500" size={32} />,
    color: "from-green-500 to-teal-500",
    bgGradient: "from-green-50 to-teal-50",
    features: [
      { icon: <FaRocket className="text-green-500" size={32} />, title: "Quick Approvals", desc: "Minimal documentation processing" },
      { icon: <FaBriefcase className="text-green-500" size={32} />, title: "Business Solutions", desc: "Custom financial solutions for SMEs" },
      { icon: <FaChartLine className="text-green-500" size={32} />, title: "Investment Products", desc: "Secure options for steady returns" },
      { icon: <FaSearch className="text-green-500" size={32} />, title: "Transparent Processes", desc: "No hidden charges or complications" }
    ],
    services: [
      {
      ...
      },
      {
        ...
        icon: <FaChartLine className="text-green-400" size={32} />,
        color: "from-green-400 to-green-600"
      }
    ],
  ...
  },
  {
    ...
    // icon: <FaMoneyBillWave className="text-amber-500" size={32} />,
  ...
  },
  {
    id: 16,
    name: "Anand Youth",
    tagline: "Compassion in action. Service with purpose.",
    ...
    // icon: <FaSeedling className="text-orange-500" size={32} />,
    color: "from-orange-500 to-red-500",
    bgGradient: "from-orange-50 to-red-50",
    features: [
      { icon: <FaTree className="text-orange-500" size={32} />, title: "Environmental Care", desc: "Plantation drives and green living" },
      { icon: <FaUtensils className="text-orange-500" size={32} />, title: "Food Support", desc: "Free meals for those in need" },
      { icon: <FaTshirt className="text-orange-500" size={32} />, title: "Clothing Distribution", desc: "Restored clothes for underprivileged" },
      { icon: <FaAmbulance className="text-orange-500" size={32} />, title: "Disaster Relief", desc: "Immediate assistance during calamities" }
    ],
    services: [
      {
        title: "Community Service",
        description: "Social welfare activities bringing positive change to every corner",
        icon: <FaHandsHelping className="text-orange-400" size={32} />,
        color: "from-orange-400 to-orange-600"
      },
      {
        title: "Environmental Care",
        description: "Tree planting and free plant distribution for eco-friendly living",
        icon: <FaGlobeAmericas className="text-red-400" size={32} />,
  ...
  },
  {
    ...
    // icon: <FaOm className="text-yellow-500" size={32} />,
  ...
  },
  {
    ...
    // icon: <FaHandsHelping className="text-blue-500" size={32} />,
    color: "from-blue-500 to-purple-500",
    bgGradient: "from-blue-50 to-purple-50",
    features: [
      { icon: <FaGraduationCap className="text-blue-500" size={32} />, title: "Education Support", desc: "Quality education and academic guidance" },
      { icon: <FaHeart className="text-blue-500" size={32} />, title: "Emotional Care", desc: "Counselling and moral guidance" },
      { icon: <FaShieldAlt className="text-blue-500" size={32} />, title: "Protection", desc: "Safe environment for vulnerable individuals" },
      { icon: <FaBook className="text-blue-500" size={32} />, title: "Skill Development", desc: "Value-based learning for brighter futures" }
    ],
    services: [
      {
  ...
  },
  {
    ...
    // icon: <FaUtensils className="text-amber-500" size={32} />,
    color: "from-amber-500 to-orange-500",
    bgGradient: "from-amber-50 to-orange-50",
    features: [
      { icon: <FaTint className="text-amber-500" size={32} />, title: "AmruthDhan Pure Milk", desc: "100% pure buffalo milk with stringent quality checks" },
      { icon: <FaUtensils className="text-amber-500" size={32} />, title: "FamAdda Regional Foods", desc: "Authentic delicacies from across India" },
      { icon: <FaCheckCircle className="text-amber-500" size={32} />, title: "Quality Guaranteed", desc: "No additives, no compromise on purity" },
      { icon: <FaBook className="text-amber-500" size={32} />, title: "Cultural Heritage", desc: "Preserving traditional recipes and craftsmanship" }
    ],
    services: [
      {
        title: "AmruthDhan Milk",
        description: "100% pure buffalo milk delivered fresh from trusted dairy farms",
        icon: <FaTint className="text-green-400" size={32} />,
        color: "from-green-400 to-green-600"
      },
      {
        title: "FamAdda Regional Foods",
        description: "Authentic regional specialties sourced directly from original creators",
        icon: <FaMapMarkerAlt className="text-orange-400" size={32} />,
        color: "from-orange-400 to-orange-600"
      },
      {
        title: "Quality Assurance",
        description: "Stringent quality checks ensuring purity, safety and authenticity",
        icon: <FaCheckCircle className="text-amber-400" size={32} />,
        color: "from-amber-400 to-amber-600"
      }
    ],
              ...
              <div className={`relative rounded-3xl overflow-hidden shadow-2xl transform group-hover:scale-[1.02] transition-all duration-500 bg-gradient-to-br ${division.color}`}>
                ...
                <div className="relative w-full h-96 flex items-center justify-center">
                  <div className="text-center text-white">
                    {/* <div className="text-5xl mb-4 mx-auto">{division.icon}</div> */}
