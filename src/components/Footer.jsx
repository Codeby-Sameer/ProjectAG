        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div className="space-y-4">
            ...
            <div className="flex space-x-4 pt-2">
              <a href="#" className="w-10 h-10 bg-blue-800 rounded-full flex items-center justify-center hover:bg-gold hover:text-navy transition-all duration-300">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#divisions" className="text-gray-300 hover:text-gold transition-colors">Divisions</a></li>
              <li><a href="#global" className="text-gray-300 hover:text-gold transition-colors">Global Presence</a></li>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-gold">Our Divisions</h3>
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="text-gray-300 hover:text-gold transition-colors">Real Estate</a></li>
              <li><a href="#" className="text-gray-300 hover:text-gold transition-colors">Film Production</a></li>
              <li><a href="#" className="text-gray-300 hover:text-gold transition-colors">Imports & Exports</a></li>
              <li><a href="#" className="text-gray-300 hover:text-gold transition-colors">Trust Services</a></li>
              <li><a href="#" className="text-gray-300 hover:text-gold transition-colors">Youth Empowerment</a></li>
              <li><a href="#" className="text-gray-300 hover:text-gold transition-colors">Devocation</a></li>
            </ul>
          </div>
