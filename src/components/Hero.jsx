...
const Hero = () => {
  ...
  return (
    ...
    >
      {/* Dynamic Overlay */}
      <div className={`absolute inset-0 transition-all duration-1000 ease-in-out ${currentOverlay}`}></div>

      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-10">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-500/20 via-transparent to-yellow-500/20"></div>
      </div>
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-6 lg:gap-8 xl:gap-12 items-center min-h-[calc(100vh-4rem)]">
          ...
          <div className="flex flex-col justify-center space-y-4 sm:space-y-6 lg:space-y-8 order-2 lg:order-1">
            ...
            {/* Main Heading */}
            <div>
              <h1 className="text-2xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold leading-tight mb-3 sm:mb-4">
            ...
            {/* Quote Box */}
            <div className="bg-white/10 backdrop-blur-md rounded-xl sm:rounded-2xl p-4 sm:p-5 lg:p-6 border border-white/20 shadow-xl">
            ...
            {/* Stats Row */}
            <div className="grid grid-cols-3 gap-3 sm:gap-4 lg:gap-6 pt-4 sm:pt-6 border-t border-white/20">
              <div className="text-center">
                <div className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-yellow-400 mb-1">15+</div>
                <div className="text-xs sm:text-sm opacity-80">Years Experience</div>
              </div>
              <div className="text-center">
                <div className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-blue-300 mb-1">100+</div>
                <div className="text-xs sm:text-sm opacity-80">Projects</div>
              </div>
              <div className="text-center">
                <div className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-purple-300 mb-1">1000+</div>
...
<div className="w-full h-[250px] sm:h-[300px] md:h-[350px] lg:h-[400px] xl:h-[500px] order-1 lg:order-2 flex items-center justify-center mb-4 lg:mb-0">
  <div className="relative w-full h-full flex items-center justify-center">
    <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md h-full mx-auto">
      {carouselSlides.map((slide, index) => (
        ...
        >
          ...
          <div className="w-full h-4/5 bg-white/20 backdrop-blur-lg rounded-lg sm:rounded-xl lg:rounded-2xl shadow-xl overflow-hidden border border-white/20 flex items-center justify-center mx-auto">
            <div className="flex flex-col h-full justify-center p-3 sm:p-4 md:p-5 w-full">
              <div className="space-y-2 sm:space-y-3 text-center">
                ...
                {/* Subtitle */}
                {slide.subtitle && (
                  <h3 className={`text-xs sm:text-sm lg:text-base ${slide.textColor} opacity-90 font-semibold`}>
                    {slide.subtitle}
                  </h3>
                )}
                
                {/* Description */}
                <p className={`text-xs sm:text-sm ${slide.textColor} opacity-90 leading-relaxed mx-auto`}>
                  {slide.description}
                </p>
                ...
                <div className="flex items-center gap-1.5 py-0.5 justify-center">
                  ...
                  <p className={`text-xs font-semibold ${slide.textColor}`}>
                    {slide.highlight}
                  </p>
                </div>
                ...
                <div className="pt-1 flex justify-center">
                  <Link
                    to={`/${slide.path}`}
                    className="inline-flex items-center px-3 py-1.5 sm:px-4 sm:py-2 rounded-md font-bold transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg text-xs bg-white text-blue-900 hover:bg-yellow-400"
                  >
                    {slide.buttonText}
        ...
        {carouselSlides.map((_, index) => (
          <button
            ...
            className={`transition-all duration-300 rounded-full ${
              index === currentSlide
                ? 'w-5 sm:w-6 h-1 sm:h-1.5 bg-yellow-400 shadow-md'
